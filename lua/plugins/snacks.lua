return function()
    ...
    map("n", "<leader>fw", "<Cmd>lua Snacks.picker.grep_word()<CR>", { desc = "Grep Word" })
    map("n", "<leader>fr", "<Cmd>lua Snacks.picker.recent()<CR>", { desc = "Recent file" })
    map("n", "<leader>fs", "<Cmd>lua Snacks.picker.grep_buffers()<CR>", { desc = "Grep Buffers" })
