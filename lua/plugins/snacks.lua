return function()
    ...
    map("n", "<leader>fo", "<Cmd>lua Snacks.picker.recent()<CR>", { desc = "Recent file" })
    map("n", "<leader>fv", "<Cmd>lua Snacks.picker.grep_word()<CR>", { desc = "Grep Word" })
    map("n", "<leader>fx", "<Cmd>lua Snacks.picker.grep_buffers()<CR>", { desc = "Grep Buffers" })
